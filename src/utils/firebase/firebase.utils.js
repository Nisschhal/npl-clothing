...
export const signInWithGooglePopup = () => signInWithPopup(auth, googleProvider); // for the popup signIn providing the auth instance and google auth provider
...
export const createUserDocumentfromAuth = async (userAuth) => {
    ...
    if (!userSnapshot.exists()) {
        ...
        try{
            await setDoc(userDocRef, {displayName, email, phoneNumber, createdAt } );
        } catch(err) {
